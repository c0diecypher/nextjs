...
const filtered = ({items}) => {
  ...
  const applyFiltersAndSort = () => {
    let updatedProducts = items.slice();
    ...
    <div className="filters">
      {filtersVisible && (
        <div className="filters-body">
          <h2>Фильтр</h2>
          <div className="filter-price-text"><span>Цена, <strong>₽</strong></span></div>
      ...
      {filtersApplied ? (
        <div className="active-filter-text">
          ...
          <div className="main-button">
              <button onClick={handleFiltersChange}>Перейти к оплате</button>
          </div>
      )}
